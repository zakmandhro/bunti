...
const runDemo = async () => {
  ...
  const frame = bunti.joinVertical(
    bunti.box(pc.bold("🛰️  BUNTI NAMESPACED ENGINE"), { align: 'center', width: 60, border: 'normal', borderColor: pc.magenta }),
    panel(
    ...
    bunti.box(pc.dim("Usage: import { bunti } from 'bunti'"), { width: 60, align: 'center' })
  );
